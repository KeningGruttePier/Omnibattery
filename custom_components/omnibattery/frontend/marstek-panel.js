...
const I18N = {
  ...
  es: {
    ...
    itemArbitrageMargin: "Margen mínimo de arbitraje", itemRoundTripEfficiency: "Eficiencia de ciclo completo", itemMaxPrice: "Precio máximo (carga)", itemDischargePrice: "Precio mínimo de descarga", itemPriceDischarge: "Descargar solo si precio alto", itemReevaluatePrices: "Reevaluar precios ahora", itemNegativePriceCharging: "Cargar con precios negativos", itemNegativePriceImportThreshold: "Umbral de precio negativo de importación", itemNegativePriceTargetSoc: "SOC objetivo por precio negativo", itemSmartPredischarge: "Predescarga inteligente", itemNegativeThreshold: "Umbral de inyección negativa", itemPredischargeReserve: "SOC de reserva de predescarga", itemPredischargeExport: "Límite de exportación de predescarga", itemCurtailmentMargin: "Margen de headroom anti-vertido",
  ...
  ca: {
    ...
    itemArbitrageMargin: "Marge mínim d'arbitratge", itemRoundTripEfficiency: "Eficiència de cicle complet", itemMaxPrice: "Preu màxim (càrrega)", itemDischargePrice: "Preu mínim de descàrrega", itemPriceDischarge: "Descarregar només si preu alt", itemReevaluatePrices: "Reavaluar preus ara", itemNegativePriceCharging: "Carregar amb preus negatius", itemNegativePriceImportThreshold: "Llindar de preu negatiu d'importació", itemNegativePriceTargetSoc: "SOC objectiu per preu negatiu", itemSmartPredischarge: "Predescàrrega intel·ligent", itemNegativeThreshold: "Llindar d'injecció negativa", itemPredischargeReserve: "SOC de reserva de predescàrrega", itemPredischargeExport: "Límit d'exportació de predescàrrega", itemCurtailmentMargin: "Marge d'espai anti-abocament",
  ...
  fr: {
    ...
    itemArbitrageMargin: "Marge d'arbitrage min.", itemRoundTripEfficiency: "Rendement aller-retour", itemMaxPrice: "Prix max. (charge)", itemDischargePrice: "Prix plancher de décharge", itemPriceDischarge: "Décharger si prix élevé", itemReevaluatePrices: "Réévaluer les prix", itemNegativePriceCharging: "Charger aux prix négatifs", itemNegativePriceImportThreshold: "Seuil de prix d'import négatif", itemNegativePriceTargetSoc: "SOC cible au prix négatif", itemSmartPredischarge: "Pré-décharge intelligente", itemNegativeThreshold: "Seuil d'injection négative", itemPredischargeReserve: "SOC de réserve de pré-décharge", itemPredischargeExport: "Limite d'export de pré-décharge", itemCurtailmentMargin: "Marge de réserve anti-écrêtement",
...
const SYS_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "negative_price_charging_threshold", lk: "itemNegativePriceImportThreshold", icon: "mdi:cash-minus" },
      { key: "negative_price_charging_target_soc", lk: "itemNegativePriceTargetSoc", icon: "mdi:battery-charging-100" },
...
const SYS_HELP = {
  en: {
    ...
    negative_price_charging: "Opt-in dynamic-pricing charging when the normalized grid import price is at or below the configured threshold, even when the forecast has no energy deficit.",
    negative_price_charging_threshold: "Inclusive normalized import-price threshold (≤). This is separate from the negative injection threshold used by solar anti-curtailment.",
    negative_price_charging_target_soc: "SOC ceiling used only in qualifying negative-price slots. Each battery remains capped by its own configured maximum SOC.",
  ...
  es: {
    ...
    negative_price_charging: "Carga opcional con precios dinámicos cuando el precio normalizado de importación es menor o igual que el umbral, aunque no exista déficit previsto.",
    negative_price_charging_threshold: "Umbral inclusivo (≤) del precio de importación. Es independiente del umbral de inyección negativa del anti-vertido solar.",
    negative_price_charging_target_soc: "SOC objetivo aplicado solo en franjas de precio negativo válidas, limitado por el SOC máximo de cada batería.",
